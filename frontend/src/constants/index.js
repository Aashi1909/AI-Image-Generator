export const surpriseMePrompts = [
    'A polar bear having tea with a penguin in a Victorian parlor, oil painting.', 
    'A robotic octopus repairing a submarine, 3D render.',
    ...
    'A treehouse village connected by rope bridges, at sunset, digital painting.',
    ...
    'A cozy log cabin in the mountains with a roaring fire and a starry night sky, digital painting.',
    ...
    'A ship sailing through the clouds, with a waterfall pouring into the sky, fantasy art.',
    ...
    'A mystical forest where the trees have glowing runes carved into them, digital painting.',
    'Synthwave aeroplane',
    'A man wanders through the rainy streets of Tokyo, with bright neon signs, 50mm',
    'A Space Shuttle flying above Cape Town, digital art',
    'A whimsical garden filled with oversized mushrooms and fairies',  
    'A carnival on Mars, with Ferris wheels and roller coasters, retro-futuristic.', 
  ];